            ...
            case 'E'://ENTER
            {
                if (tur==1 && p1[position]!=1 &&p2[position]!=1){
                    ...
                    if ((p1[1] ==1 && p1[2] ==1 &&p1[3] ==1)||
                        (p1[4] ==1 && p1[5] ==1 &&p1[6] ==1)||
                        (p1[7] ==1 && p1[8] ==1 && p1[9] ==1)||
                        (p1[1] ==1 && p1[5] ==1 &&p1[9] ==1)||
                        (p1[3] ==1 && p1[5] ==1 &&p1[7] ==1)||
                        (p1[1] ==1 && p1[4] ==1 &&p1[7] ==1)||
                        (p1[2] ==1 && p1[5] ==1 &&p1[8] ==1)||
                        (p1[9] ==1 && p1[6] ==1 &&p1[3] ==1) ) {
                            locate(0,40);
                            printf("%s won",p1name);
                            getch();
                        system("cls");
                    ...
                    if ((p2[1] ==1 && p2[2] ==1 &&p2[3] ==1)||
                        (p2[4] ==1 && p2[5] ==1 &&p2[6] ==1)||
                        (p2[7] ==1 && p2[8] ==1 && p2[9] ==1)||
                        (p2[1] ==1 && p2[5] ==1 &&p2[9] ==1)||
                        (p2[3] ==1 && p2[5] ==1 &&p2[7] ==1) ||
                        (p2[1] ==1 && p2[4] ==1 &&p2[7] ==1)||
                        (p2[2] ==1 && p2[5] ==1 &&p2[8] ==1)||
                        (p2[9] ==1 && p2[6] ==1 &&p2[3] ==1)) {
                        locate(0,40);
                        printf("%s won",p2name);
                        getch();
                        system("cls");
